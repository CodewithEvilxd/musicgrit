...
/// musicmusicgrit - Git-like version control for playlists
///
/// Track changes, sync across platforms, and play music from
/// Spotify and YouTube with a unified terminal interface.
#[derive(Parser, Debug)]
#[command(name = "musicmusicgrit")]
#[command(version)]
#[command(about = "Git-like version control for playlists")]
#[command(long_about = "musicmusicgrit - Version control for your music\n\n\
                   Track playlist changes, sync across Spotify and YouTube,\n\
                   and play music with a beautiful TUI.\n\n\
                   EXAMPLES:\n  \
                     musicmusicgrit auth spotify\n  \
                     musicmusicgrit init https://open.spotify.com/playlist/...\n  \
                     musicmusicgrit search \"lofi beats\"\n  \
                     musicmusicgrit add <track-id>\n  \
                     musicmusicgrit commit -m \"add chill vibes\"\n  \
                     musicmusicgrit push\n  \
                     musicmusicgrit play -l <playlist-id>")]
pub struct Cli {
    #[arg(
        short,
        long,
